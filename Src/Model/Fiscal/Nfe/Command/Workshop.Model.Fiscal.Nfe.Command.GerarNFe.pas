...
begin
  Result := Self;
  FParent.Component.This.NotasFiscais.GerarNFe;
  FParent.Observer.Notify('NFe Gerada com Sucesso');
end;

class function TModelFiscalNfeCommandGerarNFe.New(Parent: iModelFiscalNfe)
  : iCommand;
begin
